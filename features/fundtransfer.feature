...
Feature: Customer Transfer's Fund
		 As a customer, I want to transfer funds so that I can send money to my friends and family
...
Scenario: Valid Payee
		 ...
		 Then ensure the fund transfer is complete with $100 transferred successfully to Tim!! message
